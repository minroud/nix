...
describe('StatusBar Icons', () => {
  it('Displays phone signal', () => {
    const { container } = render(
      <StatusBar icons={[{ type: StatusBarIconType.PhoneSignal, state: StatusBarIconState.Empty }]} />
    )
  ...
  it('Displays wifi signal', () => {
    const { container } = render(
      <StatusBar icons={[{ type: StatusBarIconType.WifiSignal, state: StatusBarIconState.Empty }]} />
    )
    const icon = container.getElementsByTagName('ion-icon')[0].src
  ...
  it('Displays battery gauge', () => {
    const { container } = render(
      <StatusBar icons={[{ type: StatusBarIconType.BatteryGauge, state: StatusBarIconState.Empty, batteryLife: 59 }]} />
    )
    const icon = container.getElementsByTagName('ion-icon')[0].src
